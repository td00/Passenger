...
class MainWin(QMainWindow):
    def __init__(self):
        ...
        self.editReset=QAction(QIcon(f"{directory}/assets/passenger.svg"),language["eReset"],self)
...
class LoginWindow(QWidget):
    def __init__(self):
        ...
        self.iLogo=QLabel("")
        self.iLogo.setPixmap(QPixmap(f"{directory}/assets/passenger.svg").scaled(96,96,True))
...
class RegisterWindow(QWidget):
    def __init__(self):
        ...
        self.layout=QGridLayout(self)
        self.iLogo=QLabel("")
        self.iLogo.setPixmap(QPixmap(f"{directory}/assets/passenger.svg").scaled(48,48,True))
        self.iLogo.setAlignment(Qt.AlignCenter)
